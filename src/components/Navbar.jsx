...
//         {/* Dropdown Menu */}
//         {carrierDropdown && (
//           <ul className="absolute left-0 mt-2 w-40 bg-white border rounded-md shadow-lg z-50 md:block hidden">
//             <li><MenuLink to="/internship" onClick={closeAll}>Internship</MenuLink></li>
//             <li><MenuLink to="/job" onClick={closeAll}>Job</MenuLink></li>
//             <li><MenuLink to="/live-project" onClick={closeAll}>Live Project</MenuLink></li>
//           </ul>
//         )}
//       </li>
...
//             <li><MenuLink to="/services" onClick={closeAll}>Services</MenuLink></li>
//             <li>
//               <button onClick={handleCarrierToggle} className="text-gray-700 font-medium">
//                 Carrier <span className="ml-1">▼</span>
//               </button>
//               {mobileDropdown}
//             </li>
//             <li><MenuLink to="/contact" onClick={closeAll}>Contact</MenuLink></li>
