...
// // src/pages/MentorRegistration.jsx
...
//           <div className="bg-gradient-to-r from-indigo-700 to-purple-700 py-6 px-8">
...
//                 <p>Already have an account? <a href="#" className="text-indigo-600 hover:underline">Sign in</a></p>
//               </div>
...
const MentorRegistration = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formDataToSend.append('currentJob', formData.currentJob);
      formDataToSend.append('phone', formData.phone);
      formDataToSend.append('mentorDescription', formData.mentorDescription); // Append new description
